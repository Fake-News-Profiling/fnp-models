...
from fnpmodels.processing.statistical.sentiment import sentiment as sent, AbstractSentimentAnalysisWrapper
...
from fnpmodels.experiments.statistical import get_sentiment_wrapper, AbstractStatisticalExperiment, default_svc_model
...
class CompoundSentimentExperiment(AbstractSentimentExperiment):
    ...
    @staticmethod
    def get_extractor(sentiment_wrapper: AbstractSentimentAnalysisWrapper) -> TweetStatsExtractor:
